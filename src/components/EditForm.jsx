...
//             justifyContent: 'center',
//           }}>
//             <TextField sx={{ width: '45%', paddingRight: '1rem' }} id="recetaNombre" label="Nombre de la receta" variant="standard" value={recipe.nombre}/>
...
import { useEffect, useState } from 'react'
import { useParams, useNavigate } from 'react-router-dom'
import { Grid, Box, Container, Button, Typography, TextField, InputLabel, Select, MenuItem, FormControl, NativeSelect } from '@mui/material';
      ...
      <Container sx={{
        ...
        <Box component="form" noValidate>
          <Box sx={{
            ...
            <Typography sx={{ marginTop: '15px' }}>Nombre de la receta</Typography>
            <TextField
              id="recetaNombre"
              multiline
              rows={1}
              defaultValue={recipe.nombre}
              sx={{
                width: '45%',
                marginRight: '3rem'
              }}
            ...
            <FormControl sx={{ width: '50%' }}>
              ...
              >
                ...
                <option value={'salada'}>Fit</option>
              </NativeSelect>
            </FormControl>
          </Box>
          <Box sx={{
          ...
          <Box sx={{
            ...
            <Grid container sx={{ marginBottom: '2rem' }}>
              <TextField
                id="recetaPreparacion"
                multiline
                rows={4}
                sx={{
                  width: '100%',
                }}
                defaultValue={recipe.preparacion}
              />
            </Grid>
            <Grid container sx={{ marginTop: '2rem' }}>
              <Button /* onClick={handleSubmit} */ sx={{ backgroundColor: '#775653', marginRight: '2rem' }} component="label" variant="contained" >
